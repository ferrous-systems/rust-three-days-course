...
https://htmlpreview.github.io/?https://raw.githubusercontent.com/async-rs/a-chat/master/README.html?token=AANB3M2A6UYSO5MDKBVN56C5LV6OG[HTML version (TODO: like the proper one)]
...
This section give you gradual help while you go. This section gives partial solutions to look at or refer to.

In general, we recommend to use the Rust documentation to figure out things you are missing to familiarise yourself with it. If you ever feel complete stuck or that you haven't understood something, please hail the trainers quickly.
